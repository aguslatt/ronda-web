...
export const SHOTS: Record<string, ShotInput> = {
  ...
  apertura: {
    cam: [0.8, 0.22, 0.98], target: [0.12, 0.07, 0.32], fov: 29, fx: 0.3, fy: 0.02,
    light: 0, lid: 1, offer: 0, ronda: 0, gather: 0, dim: 0,
    mobile: { cam: [0.62, 0.34, 1.25], target: [0.1, 0.06, 0.28], fov: 38, fx: 0, fy: 0.2 },
  },
  // El hallazgo: la mesa grande, casi vacía; la escena se lee a la izquierda
  hallazgo: {
    cam: [-1.05, 1.05, 1.2], target: [0.1, 0, 0.18], fov: 33, fx: -0.24, fy: 0,
    light: 0.1, lid: 1, offer: 0, ronda: 0, gather: 0, dim: 0,
    mobile: { cam: [-1.1, 1.35, 1.55], target: [0.05, 0, 0.15], fov: 40, fx: 0, fy: 0.24 },
  },
  // La marca: acercamiento al envase y a su medallón de dos manos
  marca: {
    cam: [-0.05, 0.14, 0.64], target: [-0.33, 0.1, 0.17], fov: 27, fx: 0.2, fy: 0,
    light: 0.14, lid: 1, offer: 0, ronda: 0, gather: 0, dim: 0,
    mobile: { cam: [0.02, 0.22, 0.95], target: [-0.33, 0.1, 0.17], fov: 34, fx: 0, fy: 0.3 },
  },
  // El público: vista baja; los lugares vacíos alrededor de la mesa
  publico: {
    cam: [1.4, 0.4, -0.2], target: [0, 0.04, 0.08], fov: 33, fx: -0.22, fy: 0,
    light: 0.24, lid: 1, offer: 0, ronda: 0, gather: 0, dim: 0,
    mobile: { cam: [1.6, 0.62, -0.25], target: [0, 0.04, 0.08], fov: 42, fx: 0, fy: 0.22 },
  },
  ...
  cierre: {
    cam: [0.0, 1.55, -1.95], target: [0, 0.02, 0], fov: 34, fx: 0, fy: -0.17,
